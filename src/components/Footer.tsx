        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://www.instagram.com/winesocietylausanne/" target="_blank" rel="noopener noreferrer" className="text-cream-200/30 hover:text-gold-400 transition-colors duration-300">
              ...
              <a href="https://www.linkedin.com/company/wine-society-lausanne/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="text-cream-200/30 hover:text-gold-400 transition-colors duration-300">
